...
namespace MirasolTest
{
    ...
    public class FilterTest
    {
        ...
        public void TorroxFilterTester()
        {
            ...
            Address addressKlaus = new Address()
            {
                Id = 3,
                City = "Esbjerg",
                Country = "Denmark",
            ...
            Prices pricePuntaDelFaro = new Prices()
            {
                Id = 1,
                BeachTowels = 5,
                FinalCleaning = 80,
            ...
            Prices priceCalaceite = new Prices()
            {
                Id = 2,
                FinalCleaning = 85,
                LowSeason = 395,
            ...
            Facilities facility3 = new Facilities()
            {
                Id = 3,
            ...
            Facilities facility4 = new Facilities()
            {
                Id = 4,
            ...
            Facilities facility5 = new Facilities()
            {
                Id = 5,
            ...
            Facilities facility6 = new Facilities()
            {
                Id = 6,
                General = "Linen provided, towels provided",
